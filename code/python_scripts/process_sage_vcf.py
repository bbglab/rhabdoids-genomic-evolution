...
def process_mutect2(row, tum_col, nor_col):
    ...
    row['t_AF'] = row[tum_col].split(':')[3]
    row['n_AF'] = row[nor_col].split(':')[3]
    row['t_ref_reads'] = int(row[tum_col].split(':')[2].split(',')[0])
    row['t_alt_reads'] = int(row[tum_col].split(':')[2].split(',')[1])
    row['DP_tumor'] = int(row['t_ref_reads']+row['t_alt_reads'])
    row['n_ref_reads'] = int(row[nor_col].split(':')[2].split(',')[0])
    row['n_alt_reads'] = int(row[nor_col].split(':')[2].split(',')[1])
    row['DP_normal'] = int(row[nor_col].split(':')[4])

...
def prepare_table_annotations(input_dir,output_dir,tumor_sample_id,normal_sample_id,caller,gnomad_threshold,
                              cnv_file,purity_file,purity,ccf_threshold_clonals):
    ...
    germ_akh_df = pd.read_excel('/data/bbg/projects/sjd_pediatric_tumors/data/germline_muts_data/41467_2020_16067_MOESM5_ESM.xlsx',skiprows=2)
    ...
    if caller == 'sage' or caller =='hc':
        ...
        if purity_file != None:
            ...
            print('Please indicate purity value (--purity_file or --purity)')
